...
_LEGACY_FORWARDERS = (
    ...
    "build_broadcast_campaign_config",
    "try_start_broadcast_run",
    "get_active_broadcast_run",
    "get_latest_broadcast_run",
    "get_broadcast_run",
    "complete_broadcast_run",
    "claim_broadcast_recipient",
    "finalize_broadcast_send",
    "release_broadcast_claim",
    "apply_broadcast_send_result",
    "clone_broadcast_campaign",
    "campaign_is_due_for_run",
    "campaign_from_run_snapshot",
    "execute_broadcast_campaign_pass",
    "validate_broadcast_filters",
    "validate_broadcast_telegram_html",
    "set_broadcast_campaign_last_error",
    "abort_broadcast_run",
    "format_broadcast_audience_label",
