...
`periodic_subscription_check` крутится вечно на loop основного бота (тик 300 с). Фонового опроса HWID и рассылки админам о превышении лимита устройств нет: лимит соблюдает Remnawave, список устройств бот и Mini App берут live по действию пользователя. Внутри троттлит:
